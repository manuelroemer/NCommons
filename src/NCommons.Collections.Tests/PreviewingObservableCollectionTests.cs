namespace NCommons.Collections.Tests
{
    ...
    public abstract class PreviewingObservableCollectionTests
    {

        protected static Assert.RaisedEvent<NotifyCollectionChangedEventArgs> AssertRaisesCollectionChanging<T>(
            PreviewingObservableCollection<T> collection,
            Action testCode)
        {
            return AssertEx.Raises<NotifyCollectionChangingEventHandler, NotifyCollectionChangedEventArgs>(
        ...
        public class EventArgsTests : PreviewingObservableCollectionTests
        {
        ...
        public class BlockReentrancyTests : PreviewingObservableCollectionTests
        {
        ...
        public class CollectionChangingTests : PreviewingObservableCollectionTests
        {
