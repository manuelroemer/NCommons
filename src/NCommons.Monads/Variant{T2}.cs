namespace NCommons.Monads
{
    ...
    /// <summary>
    ///     A type which is able to hold one of up to 2 possible values and provides methods for
        ...
        IEquatable<Variant<T1, T2>>
    {
        ...
        /// </exception>
        public void Match(Action<T1> onValue1, Action<T2> onValue2, Action onEmpty)
        {
            this.MatchInternal<T1, T2, Dummy, Dummy, Dummy, Dummy, Dummy, Dummy>(
        ...
        ///     Thrown if any of the parameters is <see langword="null"/>.
        /// </exception>
        public T Match<T>(Func<T1, T> onValue1, Func<T2, T> onValue2, Func<T> onEmpty)
        {
            return this.MatchInternal<T, T1, T2, Dummy, Dummy, Dummy, Dummy, Dummy, Dummy>(
                onValue1 ?? throw new ArgumentNullException(nameof(onValue1)),
                onValue2 ?? throw new ArgumentNullException(nameof(onValue2)),
                onValue3: null,
                onValue4: null,
